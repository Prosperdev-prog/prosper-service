  ...
  <main id="main" data-aos="fade-in">
    ...
    <section>
      <div class="container mt-5">
        <form action="connexion-etudiant.php" method="POST" enctype="multipart/form-data">     
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="etat_de_tache" name="etat_de_tache" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="assignation" name="assignation" required>
                </div>
                <div class="mb-3">
                    <label for="priorite" class="form-label">Priorité</label>
                    <input type="text" class="form-control" id="priorite" name="priorite" required>
                </div>
                <div class="mb-3">
                
                    <label for="commentaire" class="form-label">Commentaire</label>
                    <textarea class="form-control" name="commentaire" rows="5" placeholder="Message" required></textarea>
                </div>
