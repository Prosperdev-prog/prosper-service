...
<body>
  ...
  <header id="header" class="fixed-top">
    ...
    <h1 class="logo me-auto"><a href="index.html">PROSPER service</a></h1>
...
<nav id="navbar" class="navbar order-last order-lg-0">
  ...
  <li><a href="index.php">ACCEUIL</a></li>
    ...
    <li><a class="active" href="connexion.php">CREER UN COMPTE</a></li>
    ...
    <section>
      <div class="container mt-5">
        ...
        <div class="container mt-5">
          ...
          <form action="users/users-connexion.php" method="POST">
              ...
              <div class="mb-3">
                  ...
                  <input type="password" class="form-control" id="motDePasse" name="password_conn" required>
              </div>
